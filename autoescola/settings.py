...
Sistema de Gestao para Autoescola Fenix
"""
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-b4)@v%-nynk&)il4y10pj&59r@a-77d&e_qa2v9$sbxd1lg6cp')
...
# WhatsApp Mock Number (for development)
WHATSAPP_MOCK_NUMBER = '13981388978'
